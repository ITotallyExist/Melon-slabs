...
public class TorturedPhantomEntityModel<T extends TorturedPhantomEntity>
extends SinglePartEntityModel<T> {
    ...
    public TorturedPhantomEntityModel(ModelPart root) {
        this.root = root;
    ...
    @Override
    public void setAngles(T torturedPhantomEntity, float f, float g, float h, float i, float j) {
        float k = ((float)((TorturedPhantomEntity)torturedPhantomEntity).getWingFlapTickOffset() + h) * 7.448451f * ((float)Math.PI / 180);
        float l = 16.0f;
